	...
	for (i = 0; i < concertData.length; i++) {
		...
		<div class="jumbotron">\
			<h2>' + concertData[i].name + '</h2>\
				...
				<div class="panel-group" id="accordion-' + concertData[i].id + '"></div>\
		</div>'
		);
...
$('#accordion-' + concertId).empty();
  for (i = 0; i < songData.length; i++) {
    if (songData[i][0].arrangement_id == "-1") {
	
	$('#accordion-' + concertId).append('\
    <div class="panel panel-default">\
      <a data-toggle="collapse" data-parent="#accordion">\
        <div class="panel-heading text-left">\
          <h4 class="panel-title">Väliaika</h4>\
        </div>\
      </a>\
